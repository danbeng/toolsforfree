...
updated: 2026-09-12T08:40:00Z
---

## Current Test

number: 4
name: 打开 /tools/password-generator/：页面加载即有密码；Copy；再 Generate；关掉全部字符集再 Generate；打开 /zh/ 看错误文案
expected: |
  加载即生成；可复制；再生成会变；空字符集报错而非空白成功；中文页显示「请至少选择一种字符集」；首页精选 6、目录 14 个工具
awaiting: none
